...
if(NOT opm-common_FOUND)
  ...
  set (opm-common_INCLUDE_DIRS "/usr/local/include;/usr/include;/usr/include/cjson")
  set (opm-common_LIBRARY_DIRS "/usr/lib/x86_64-linux-gnu" "/usr/local/lib")
  ...
  set (opm-common_LIBRARY "/usr/local/lib/libopmcommon.a")
  ...
  if (NOT DEST_PREFIX)
    ...
    set(CMAKE_MODULE_PATH "${CMAKE_MODULE_PATH}" /usr/local/share/opm/cmake/Modules)
    ...
    #ENABLE_ECL_INPUT is needed by opm-common-prereq.cmake
                                       ...
                                       include(OpmPackage) #Make macros available after find_package(opm-common)
                                        set(COMPARE_ECL_COMMAND /usr/local/bin/compareECL)
                                        set(OPM_PACK_COMMAND /usr/local/bin/opmpack)
                                        set(RST_DECK_COMMAND /usr/local/bin/rst_deck)
